...
```
จาก posible_paths ทำให้เราสามารถหาลำดับที่ดีที่สุดได้ โดยที่
1. Start -> Goal 1 -> Goal 2 -> Goal 3 ใช้ระยะทาง 3.0787608005179976 + 2.638937829015426 + 1.5707963267948961  = 7.28849495632832
2. Start -> Goal 1 -> Goal 3 -> Goal 2 ใช้ระยะทาง 3.0787608005179976 + 1.6964600329384882 + 1.5707963267948961 = 6.346017160251382
3. Start -> Goal 2 -> Goal 1 -> Goal 3 ใช้ระยะทาง 2.5761059759436304 + 2.638937829015426  + 1.6964600329384882 = 6.911503837897545
4. Start -> Goal 2 -> Goal 3 -> Goal 1 ใช้ระยะทาง 2.5761059759436304 + 1.5707963267948961 + 1.6964600329384882 = **5.843362335677015** # Paths สั้นที่สุด เลือกใช้ Path นี้ 
5. Start -> Goal 3 -> Goal 1 -> Goal 2 ใช้ระยะทาง 4.146902302738527  + 1.6964600329384882 + 2.638937829015426  = 8.482300164692441
6. Start -> Goal 3 -> Goal 2 -> Goal 1 ใช้ระยะทาง 4.146902302738527  + 1.5707963267948961 + 2.638937829015426  = 8.356636458548849
